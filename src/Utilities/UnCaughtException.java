...
public class UnCaughtException implements UncaughtExceptionHandler{
    ...
    /**
     * <span id="IL_AD9" class="IL_AD">This method</span> for call alert dialog when application crashed!
     */
    public void sendErrorMail(final StringBuilder errorContent) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                builder.setTitle("Có vấn đề xảy ra...!");
                builder.create();
                ...
                builder.setPositiveButton("Báo cáo",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                ...
                                sendIntent.putExtra(Intent.EXTRA_EMAIL,
                                        new String[] { "lenhutthanhquang@gmail.com" });
